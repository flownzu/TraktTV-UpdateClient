...
namespace TraktTVUpdateClient
{
    ...
    public class Slider : Control
    {
        ...
        {
            Rectangle slideRect = new Rectangle(Point.Empty, new Size(this.Width, this.Height));
            graphics.DrawRectangle(Pens.Gray, slideRect);
            graphics.FillRectangle(new SolidBrush(Color.DarkGray), slideRect);
            Rectangle progressRect = new Rectangle(Point.Empty, new Size(KnobX, this.Height));
            _bufGraphics.Graphics.DrawRectangle(Pens.LightSkyBlue, progressRect);
            _bufGraphics.Graphics.FillRectangle(new SolidBrush(Color.LightSkyBlue), progressRect);
        }
